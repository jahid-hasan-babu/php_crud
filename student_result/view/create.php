                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body">
                        <form action="insert.php" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label fw-bold text-dark">Roll</label>
                                <input type="text" class="form-control border-success no-outline" name="roll"
                                    placeholder="Enter your ID">
                                <span class="text-danger"><?= isset($err_roll) ? $err_roll : '' ?></span>
                            </div>
                            <div class="form-group mb-3">
